...
public class Square extends CordovaPlugin {
	...
	private static final String OPT_CURRENCY = "currencyCode";
	...
	private static final String OPT_NOTE = "notes";
	private static final String OPT_METADATA = "metadata";
    private static final String OPT_CUSTOMER_ID = "customerId";
	...
	private void setOptions(final JSONObject options) {
        ...
        if(options.has(OPT_CUSTOMER_ID)) this.customerId = options.optString(OPT_CUSTOMER_ID);
	}
